...
public class CanvasDemo : MonoBehaviour 
{
	...
	public Toggle stackedLabelToggle;
	...
	public void OnValueChanged(string input)
	{
		...
		else if (input == "stacked")
		{
			barChart.stacked = stackedLabelToggle.isOn;
		}
	}
	...
	public void UpdateLabels()
	{
		...
		if (positions != null)
		{
			for (int i = 0; i < lineYLabels.Count; i++)
			{
				if (positions.Length - 1 < i)
				{
